...
<html lang="es">
    <head>
        <meta charset="uft-8" />
        <title>Sistema de Saldos Calendarizados</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="assets/css/dialogo.css">
        <link rel="stylesheet" type="text/css" href="assets/css/login_style.css"/>
        <?php         
            //include("SisCal00_00VarSesion.php");
            session_start();
        ?>
    </head>
    <body>  
        ...
        <div id="main_container">
            ...
            <div class="brand">
                <h1><span>Sistema de Saldos Calendarizados</span></h1>
            </div>
            ...
            <div class="container">
                ...
                <div class="login-content">
                    <form name="form1" id="form1" method="post" action="back/login_.php" enctype="application/x-www-form-urlencoded">
                        ...
                        <div>
                            <label class="label"><?//=$_SESSION['SisCalError']?></label>
                        </div>
            ...
            <div id="errors">
                <?php //echo $_SESSION['SisCalError']; ?>
            </div>
        </div>
        <div id="footer">
            <?php include("SisCal00_footer_nuevo.php"); ?>
        </div>
        ...
        <script>
            ...
            function verificarError() {
                ...
                var error = "<?php 
                    if ( isset($_SESSION['SisCalError']) ){
                        if (trim($_SESSION['SisCalError'])!=""){
                            echo $_SESSION['SisCalError'];
                        }else{
                            echo "";
                        }
                    }else{
